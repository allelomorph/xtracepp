...
int main( const int argc, const char* const* argv ) {
    ...
    case GETPROPERTY:              {  //  20
        ...
        // TBD AnyPropertyType XCB_GET_PROPERTY_TYPE_ANY will still give the
        //   prop type atom if prop exists
        ...
        const xcb_get_property_cookie_t cookie {
            xcb_get_property( connection, _delete, window, property,
    ...
    case GRABPOINTER:              {  //  26
        ...
        const xcb_grab_pointer_cookie_t cookie {
            xcb_grab_pointer( connection, owner_events, grab_window, event_mask,
    ...
    case GRABKEYBOARD:             {  //  31
        ...
        const xcb_grab_keyboard_cookie_t cookie {
            xcb_grab_keyboard( connection, owner_events, grab_window, time,
    ...
    case GETMOTIONEVENTS:          {  //  39
        ...
        const xcb_get_motion_events_cookie_t cookie {
            xcb_get_motion_events( connection, window, start, stop ) };
    ...
    case QUERYTEXTEXTENTS:         {  //  48
        ...
        const xcb_query_text_extents_cookie_t cookie {
            xcb_query_text_extents( connection, font, string_len, string ) };
    ...
    case LISTFONTS:                {  //  49
        ...
        const xcb_list_fonts_cookie_t cookie {
            xcb_list_fonts( connection, max_names, pattern_len, pattern ) };
    ...
    case LISTFONTSWITHINFO:        {  //  50
        ...
        const xcb_list_fonts_with_info_cookie_t cookie {
            xcb_list_fonts_with_info( connection, max_names, pattern_len, pattern ) };
    ...
    case GETIMAGE:                 {  //  73
        ...
        const xcb_get_image_cookie_t cookie {
            xcb_get_image( connection, format, drawable, x, y, width, height, plane_mask ) };
    ...
    case ALLOCCOLOR:               {  //  84
        ...
        const xcb_alloc_color_cookie_t cookie {
            xcb_alloc_color( connection, cmap, red, green, blue ) };
    ...
    case ALLOCNAMEDCOLOR:          {  //  85
        ...
        const xcb_alloc_named_color_cookie_t cookie {
            xcb_alloc_named_color( connection, cmap, name_len, name ) };
    ...
    case QUERYCOLORS:              {  //  91
        ...
        const xcb_query_colors_cookie_t cookie {
            xcb_query_colors( connection, cmap, pixels_len, pixels ) };
    ...
    case LOOKUPCOLOR:              {  //  92
        ...
        const xcb_lookup_color_cookie_t cookie {
            xcb_lookup_color( connection, cmap, name_len, name ) };
    ...
    case QUERYBESTSIZE:            {  //  97
        ...
        const xcb_query_best_size_cookie_t cookie {
            xcb_query_best_size( connection, _class, drawable, width, height ) };
    ...
    case QUERYEXTENSION:           {  //  98
        ...
        const xcb_query_extension_cookie_t cookie {
            xcb_query_extension( connection, name_len, name ) };
    ...
    case SETPOINTERMAPPING:        {  // 116
        ...
        const xcb_set_pointer_mapping_cookie_t cookie {
            xcb_set_pointer_mapping( connection, map_len, map ) };
