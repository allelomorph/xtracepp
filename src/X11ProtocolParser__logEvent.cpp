...
X11ProtocolParser::_parseEvent< protocol::events::impl::InputEvent >(
    ...
    outputs.str = fmt::format(
        ...
        _formatCommonType( encoding->header.detail ), ws.separator,
        !settings.verbose ? "" : fmt::format(
            "{}{: <{}}{}{}{}",
        ...
        _formatCommonType( encoding->time ), ws.separator,
        ...
        _formatCommonType( encoding->event ), ws.separator,
        ...
        _formatCommonType( encoding->state ), ws.separator,
        ws.memb_indent, "same-screen", memb_name_w, ws.equals,
        _formatCommonType( encoding->same_screen ), ws.separator,
        ws.encl_indent
        );
    return outputs;
}
...
X11ProtocolParser::_parseEvent< protocol::events::impl::BoundaryEvent >(
    ...
    outputs.str = fmt::format(
        ...
        _formatInteger( encoding->focus_same_screen_mask,
...
X11ProtocolParser::_parseEvent< protocol::events::UnmapNotify >(
    ...
    outputs.str = fmt::format(
        ...
        _formatCommonType( encoding->from_configure ), ws.separator,
        ws.encl_indent
        );
    return outputs;
}
...
X11ProtocolParser::_parseEvent< protocol::events::ConfigureNotify >(
    ...
    outputs.str = fmt::format(
        ...
        _formatCommonType( encoding->above_sibling,
...
X11ProtocolParser::_parseEvent< protocol::events::ConfigureRequest >(
    ...
    outputs.str = fmt::format(
        ...
        _formatCommonType( encoding->sibling,
...
X11ProtocolParser::_parseEvent< protocol::events::SelectionClear >(
    ...
    outputs.str = fmt::format(
        ...
        _formatCommonType( encoding->owner ), ws.separator,
